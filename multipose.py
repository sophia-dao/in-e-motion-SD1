# source https://gist.github.com/lanzani/f85175d8fbdafcabb7d480dd1bb769d9
...
# change this number to match webcam index
video_source = 1
...
with vision.PoseLandmarker.create_from_options(options) as landmarker:
    ...
    while cap.isOpened():
        ...
        if to_window is not None:
            flipped = cv2.flip(to_window, 1) #mirror image
            cv2.imshow("MediaPipe Pose Landmark", flipped)
